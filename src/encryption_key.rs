...
impl EncryptionKey {
    ...
    pub fn new(n_size: u32, a_size: u32, h: Integer, n: Integer) -> Result<Self, Error> {
        ...
        let h_pow_n = crate::integer_ext::mod_pow_int(&h, &n, &nn);
    ...
    pub fn sample_112() -> Self {
        let n_size = 2048;
        let a_size = 448;
        let h = Integer::from_string_base(16, "").unwrap();
        let n = Integer::from_string_base(16, "").unwrap();
    ...
    pub fn sample_128() -> Self {
        let n_size = 3072;
        let a_size = 512;
        let h = Integer::from_string_base(10, "-").unwrap();
        let n = Integer::from_string_base(10, "").unwrap();
...
impl EncryptionKey {
    ...
    pub fn encrypt_with(&self, x: &Plaintext, nonce: &Nonce) -> Result<Ciphertext, Error> {
        ...
        let b = crate::integer_ext::mod_pow_int(self.h_pow_n(), nonce, self.nn());
...
impl EncryptionKey {
    ...
    pub fn encrypt_with_precompute_table(
        ...
        let g_pow_m = (Integer::from(1) + (m * &self.n)) % &self.nn;
